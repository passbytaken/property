define(function() {
	var is_open_login_window = false;
	return {
		Copy:function()
		{
			$(".copy-btn").each(function(index, element) {
				$(element).zclip({ 
						path:SITE_URL+'scripts/lib/ZeroClipboard.swf', 
						copy:$(element).val(),
						afterCopy:function(){ 
		...
		GetDateStr:function(AddDayCount){
			...
			for(i=0;i<22;i++){
				sendListHTML +="<li>";
				sendListHTML +=(this.GetDateStr(-1));	
				...
				quotes=new Array
				quotes[1]='<p>订购的 产品：'+item_arr[1]+' 已发货 邮政EMS <font color="#FF0000">√</font></p>'
				quotes[2]='<p>订购的 产品：'+item_arr[2]+' 已发货 圆通速递 <font color="#FF0000">√</font></p>'
				quotes[3]='<p>订购的 产品：'+item_arr[3]+' 已发货 申通快递 <font color="#FF0000">√</font></p>'
				quotes[4]='<p>订购的 产品：'+item_arr[4]+' 已发货 中通速递 <font color="#FF0000">√</font></p>'
				quotes[5]='<p>订购的 产品：'+item_arr[5]+' 已发货 韵达快运 <font color="#FF0000">√</font></p>'
				quotes[6]='<p>订购的 产品：'+item_arr[6]+' 已发货 顺风速运 <font color="#FF0000">√</font></p>'
				var quote=quotes[rand1]
				sendListHTML +=(quote)
				sendListHTML +=('</li>');
			}
