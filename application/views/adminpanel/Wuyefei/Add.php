<?php defined('BASEPATH') or exit('No direct script access allowed.'); ?>    <h3 class="page-header"><a class="btn btn-default btn-sm pull-right" href="<?php echo base_url('Adminpanel/wuyefei')?>"><span class="glyphicon glyphicon-arrow-left"></span> 返回 </a> 物业费 新增信息 </h3>  
<form class="form-horizontal" role="form" id="myform" name="myform" action="<?php echo base_url('Adminpanel//wuyefei/add')?>" >
...
<?php endforeach;?>
	  		...
	  		<div class="form-group">
				...
				<div class="col-sm-9 ">
					<input type="text" name="wuyefei_kssj"  id="wuyefei_kssj"    class="form-control datepicker  validate[required,custom[date]]"  placeholder="请输入费用开始时间" >
				</div>
			</div>
	  		<div class="form-group">
				<label for="wuyefei_jssj" class="col-sm-2 control-label">费用结束时间</label>
				<div class="col-sm-9 ">
					<input type="text" name="wuyefei_jssj"  id="wuyefei_jssj"    class="form-control datepicker  validate[required,custom[date]]"  placeholder="请输入费用结束时间" >
				</div>
			</div>
             <div class="form-group">
				<label for="wuyefei_jssj" class="col-sm-2 control-label">收费日期</label>
				<div class="col-sm-9 ">
					<input type="text" name="wuyefei_cjsj"  id="wuyefei_cjsj"    class="form-control datepicker  validate[required,custom[date]]"  placeholder="请输入收费日期" >
				</div>
			</div>
	  		<div class="form-group">
				<label for="wuyefei_fy" class="col-sm-2 control-label">费用</label>
				<div class="col-sm-9 ">
					<input type="number" name="wuyefei_fy"  id="wuyefei_fy"     class="form-control  validate[required,custom[price]]" placeholder="请输入费用" >
				</div>
			</div>
	  		      </div>
     </div>
